...
// The containing directory is created if needed. The returned lock
...
// lockShared acquires a shared lock on the given file path. The file must exist.
// The returned lock must be released by calling unlock().
